/*!
 * \file example_path3.cpp
 * \brief file example_path3.cpp
 *
...
class ExamplePath3:public Initialization
{
public:
  ExamplePath3(DemoRunner *runner, int argc, char **argv): Initialization(runner, argc, argv)
  {
  ...
  virtual void draw_frame(void) override{
...
{
  DemoRunner demo;
  return demo.main<ExamplePath3>(argc, argv);
}
